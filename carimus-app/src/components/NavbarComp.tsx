...
const NavbarComp:React.FunctionComponent = () => {
    ...
    <Navbar expand="lg">
    <div id = "logoWrapper" onClick = {() => {window.location.href = "./../"}} style = {{cursor: "pointer"}}><img id = "CarimusLogo" src={process.env.PUBLIC_URL+"/logo-header.png"} alt="Logo" /><Navbar.Brand id = "Arimus">EO ASCENZI</Navbar.Brand></div>
