...
const SwingProj: React.FunctionComponent = () => {
  return (
    <>
      <div style={firstSection}>
        ...
        <div style={lowerStyle}>
          <div style={innerLeft}>
            ...
            >
              A full-service paddle sport and health facility partnered with
              Carimus to establish their visual identity.
            </motion.div>
          </div>
          <motion.div
            style={innerRight}
          ...
          >
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <span style={{ paddingTop: "3vh" }}>
                <span style={{ fontWeight: "bolder" }}>Client</span> Swing
                Racquet + Paddle
              </span>
              <span style={{ paddingTop: "2vh" }}>
                <span style={{ fontWeight: "bolder" }}>Industry</span> Sports,
                Fitness
              </span>
              <span style={{ paddingTop: "2vh" }}>
                <span style={{ fontWeight: "bolder" }}>Services</span> Naming,
                Branding, Messaging, Web Design, Development, Strategy, SEO
              </span>
            </div>
          </motion.div>
        </div>
